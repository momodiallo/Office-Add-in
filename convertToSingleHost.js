...
import { readFile, unlink, writeFile, existsSync, readdirSync, lstatSync, unlinkSync, rmdirSync } from "fs";
...
function deleteFolder(folder) {
  try {
    if (existsSync(folder)) {
      readdirSync(folder).forEach(function (file, index) {
